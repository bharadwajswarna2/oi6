...
window.addEventListener('DOMContentLoaded', function () {
    ...
    class Chatbox {
        ...
        bubbleUp(ai_message){
          ...
          <button onclick="window.inside_bubble_button(chatbox,'${ai_message}');removex();" >Click Me!</button>
          `
          $('#myPopup').show();
            $('#closebub').show();
      ...
      <div class="container">
          <div class="chatbox">
              ...
              <img src="https://cdn.jsdelivr.net/gh/optimus-ohya/oimax_chat@latest/frontend/images/close.png" onclick="myFunction()" class="close-bbl" alt="image" id="closebub" style="display:none">
              <div class="bubble" onclick="" id="myPopup">
